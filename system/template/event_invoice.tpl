        ...
        <section>
            <div class="container">
                ...
                <div class="row pt-4 align-items-center">
                    <div class="col-6">
                        <p class="text__black">Event: ${event_name}</p>
                        <p class="text__black">Location: ${event_addr}</p>
                        <p class="text__black">Date & Time: ${event_date}</p>
                ...
                <div class="row pt-5">
                    <div class="col-12 text-end mt-5">
                        <p class="text__black">For Tajurba Business Network Pvt
                            Ltd</p>
                    </div>
                </div>
